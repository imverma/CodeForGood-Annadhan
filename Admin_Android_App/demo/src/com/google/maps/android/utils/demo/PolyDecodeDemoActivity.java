...
public class PolyDecodeDemoActivity extends BaseDemoActivity {
    ...
    private final static String LINE = "qxxsBurs{LqtBmTamAen@y}@pqA{}AhCoc@naA";
    ...
    protected void startDemo() {
        ...
        getMap().moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(19.113645, 72.8697339), 12));
    }
}
